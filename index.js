...
console.log("𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝙺𝙰𝙽𝙶𝙾 x𝙼𝙳 🎭...");
...
console.log('𝙺𝙰𝙽𝙶𝙾 x𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙴𝙽𝙹𝙾𝚈 ✅')

let up = ` ʙᴏᴛ⇨⇨ Connected Successfully!!!!!!* ✅ 

 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴋᴀɴɢᴏ xᴍᴅ
...
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/05b4RaE.jpeg` }, caption: up })
...
app.get("/", (req, res) => {
res.send("𝙺𝙰𝙽𝙶𝙾 x𝙼𝙳 is 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 ✅");
});
app.listen(port, () => console.log(`𝙺𝙰𝙽𝙶𝙾 x𝙼𝙳 Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 4000);
